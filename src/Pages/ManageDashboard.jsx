      ...
      <Row className="mb-3 mt-5 justify-content-center">
        ...
        <div className="input">
          ...
          <div className="text-center mt-3">
            <Button onClick={handleAddCategory} className="w-30" gradientDuoTone="greenToBlue">
              Add Category
            </Button>
          </div>
          </div>
      ...
      <Row className="mb-3 mt-3 justify-content-center">
        <Col md={6}>
          <FormControl
            ...
            style={{ maxWidth: '500px', margin: 'auto' }}
          />
          {errors.widgetTitle && <Form.Control.Feedback type="invalid">{errors.widgetTitle}</Form.Control.Feedback>}
        ...
        <Col md={6}>
          ...
          <FormControl
            ...
            onChange={(e) => {
              ...
              if (e.target.value) {
                setErrors((prevErrors) => ({ ...prevErrors, widgetDescription: '' }));
              }
            }}
            isInvalid={!!errors.widgetDescription}
            style={{ maxWidth: '500px', margin: 'auto' }}
          />
          {errors.widgetDescription && <Form.Control.Feedback type="invalid">{errors.widgetDescription}</Form.Control.Feedback>}
        </Col>
      </Row>
      <Row className="mb-3 justify-content-center">
        <Col md={6}>
        <div className="input">
          <div className="text-center">
            <Button onClick={handleAddWidget} className="w-30" gradientDuoTone="greenToBlue">
              Add Widget
            </Button>
          </div>
          </div>
